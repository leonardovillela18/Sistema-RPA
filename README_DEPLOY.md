...
5. Fora de `public_html`, crie `/home1/rpamec18/private/config.php` a partir de `private/config.example.php`. Preencha DSN, usuário e senha reais; mantenha `secure_cookies` como `true`. Use permissão 600 se o PHP executar como o proprietário da conta. Não envie esse arquivo ao Git.
