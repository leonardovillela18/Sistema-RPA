...
function getRedirectTarget() { const next=new URLSearchParams(location.search).get('next'); return ['index.html','produtos.html','contato.html','sobre.html','servicos.html'].includes(next) ? '/'+next : '/index.html'; }
